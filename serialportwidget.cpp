    ...
    QFrame(parent)
{
    ...
    bytesSent = 0;
    bytesRead = 0;
    communicationStatsLabel = new QLabel(QString("(")+QString::number(bytesSent)+QString(" : ")+QString::number(bytesRead)+QString(")"));
...
{
    this->communicationStatsLabel->setText(QString("(")+QString::number(bytesSent)+QString(" : ")+QString::number(bytesRead)+QString(")"));
}
